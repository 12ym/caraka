...
class SplashLeveling5Screen extends StatefulWidget {
  const SplashLeveling5Screen({super.key});

  @override
  State<SplashLeveling5Screen> createState() => _SplashLeveling5ScreenState();
}

class _SplashLeveling5ScreenState extends State<SplashLeveling5Screen> {
  @override
